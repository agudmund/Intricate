#!/usr/bin/env python3
"""Extract the play button sticker from Images/Stickers/Play.png.
...
src = Image.open("Images/Stickers/Play.png").convert("RGBA")
...
out.save("icons/playIconic.png")

# Verify: composite on dark node background
dark_bg = Image.new("RGBA", (1024, 1024), (45, 52, 54, 255))
dark_bg.paste(out, (0, 0), out)
dark_bg.save("Documents/Data/Icon Pipeline/_verify_play_dark.png")

# Multi-resolution ICO
sizes = [16, 24, 32, 48, 64, 128, 256]
out.save("icons/playIconic.ico", format="ICO", sizes=[(s, s) for s in sizes])
print(f"Extracted play sticker {cw}x{ch_px} -> 1024x1024 png + ico")
