#!/usr/bin/env python3
"""Extract the direct/no-loop arrow sticker from directAudio.png."""
from PIL import Image
import numpy as np
from scipy.ndimage import label
from collections import deque

src = Image.open("Images/directAudio.png").convert("RGBA")
...
out.save("icons/directAudio.png")

dark_bg = Image.new("RGBA", (1024, 1024), (45, 52, 54, 255))
dark_bg.paste(out, (0, 0), out)
dark_bg.save("icons/_verify_directAudio_dark.png")

sizes = [16, 24, 32, 48, 64, 128, 256]
out.save("icons/directAudio.ico", format="ICO", sizes=[(s, s) for s in sizes])
print(f"Extracted direct audio sticker {cw}x{ch_px} -> 1024x1024 png + ico")
