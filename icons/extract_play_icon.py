#!/usr/bin/env python3
"""Extract the play button sticker from playIconic.png."""
from PIL import Image
import numpy as np
from scipy.ndimage import label
from collections import deque

src = Image.open("Images/playIconic.png").convert("RGBA")
...
print(f"Extracted play icon {cw}x{ch_px} -> 1024x1024 png + ico")
