#!/usr/bin/env python3
"""Rebuild intricate.ico from the official sticker source.

The old ICO had only a 16x16 frame — Windows fell back to the default
Python icon for taskbar/alt-tab.  This produces a full multi-resolution
ICO (16–256) from the sticker PNG.
"""
...
# ── Step 1: Flood-fill from corners to remove outer background ───────
def is_outer(y, x):
    if a[y, x] < 10:
        return True
    return (r[y, x] > 230 and g[y, x] > 230 and b[y, x] > 230 and a[y, x] > 200)
